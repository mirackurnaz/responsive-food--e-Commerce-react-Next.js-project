  ...
  const handleCreate = async () => {
    ...
    try {
      const uploadRes = await axios.post(
        "https://api.cloudinary.com/v1_1/drliaucfu/image/upload",
        data
      );
  ...
  return (
    <div className=" fixed top-0 left-0 w-screen h-screen z-50 after:content-[''] after:w-screen after:h-screen after:bg-white after:absolute after:top-0 after:left-0 after:opacity-60 grid place-content-center">
      <OutsideClickHandler onOutsideClick={() => setIsProductModal(false)}>
        <div className="w-full h-full grid place-content-center relative profileResponsive">
          <div className="relative z-50 md:w-[600px] w-[370px]  bg-white border-2 p-10 rounded-3xl">
            <Title searchClasname="text-[40px] font-bold text-center">Yeni Ürün Ekle
</Title>
            ...
            <label className="flex gap-2 items-center">
                <input
                  ...
                  className="hidden"
                />
                <button className="text-white p-2  !rounded-none !bg-blue-600 pointer-events-none">
                Bir Resim Seçin
            ...
            <div className="flex flex-col text-sm mt-4">
              <span className="font-semibold mb-[2px]">İsim</span>
              <input
                type="text"
            ...
            <div className="flex flex-col text-sm mt-4 w-full">
              ...
              <div className="flex  gap-6 w-full md:flex-nowrap flex-wrap">
                ...
                />
                <button onClick={handleExtra} className="bg-darkMe text-white hover:bg-yellowMe p-2 rounded-md ml-auto">Ekle</button>
              </div>
            ...
            <div className="flex justify-end">
              <button  onClick={handleCreate} className="  text-white p-2 rounded-md bg-yellowMe hover:bg-darkMe  ">Yükle</button>
            </div>
            <button
              className="absolute  top-4 right-4"
              onClick={() => setIsProductModal(false)}
            >
              <GiCancel size={25} className=" transition-all rounded-[100%] hover:text-white hover:bg-red-500" />
            </button>
          </div>
        </div>
      </OutsideClickHandler>
